...
export default Ember.View.extend({
  didInsertElement: function() {
    ...
    $('#step3').on('click', function () {
      ...
      $('#button-application-submit,.step4').addClass('active');
      $('#back3,.back3').removeClass('active');
      $('#back4,.back4').addClass('active');
    });
    ...
    $('#back4').on('click', function () {
      $('#step3,.step3').addClass('active');
      $('#back3,.back3').addClass('active');
      $('#button-application-submit,.step4').removeClass('active');
      $('#back4,.back4').removeClass('active');
    });
